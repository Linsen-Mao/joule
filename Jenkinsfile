            ...
            steps {
                script {
                    withCredentials([file(credentialsId: KUBECONFIG_CREDENTIALS_ID, variable: 'KUBECONFIG'),
                        ...
                        sh 'kubectl create secret generic openai-secret --from-literal=OPENAI_API_KEY="${API_KEY}" --dry-run=client -o yaml | kubectl apply -f - --insecure-skip-tls-verify=true'
